...
There were also other criteria which were preferable, but not mandatory. One of these criteria was that it would be desirable if there were several roles within
...
%TODO
\fbox{\parbox{\textwidth}{L3 -  Focus group \cite{}:
